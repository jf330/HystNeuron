...
def gekko_ode_input(datamaker):
    ...
    weight_m = np.load("/Users/jf330/new_results2/weights_N_{}_Eta_{}_A_{}_good.npy".format(datamaker.n, eta, a))
...
def synt_train_Tempotron(datamaker):
    ### Training setup
    lr = 0.0002
    to_update = 0.2
    epochs = 2000
    ...
    # neuron_A.weight_m = np.load(cwd + "/results/Temp_weights_N_{}.npy".format(datamaker.n))
    ...
    np.save(cwd + "/results/Temp_weights_N_{}.npy".format(neuron_A.pre_syn), neuron_A.weight_m)
